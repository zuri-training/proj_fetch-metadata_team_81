...
**If you wish to host this website on any platform you We used the django framework. You can find the pages in the templates folder, stylesheets in the static folder. Clone the repository, then continue the hosting using the documentation of the hosting platform.**
